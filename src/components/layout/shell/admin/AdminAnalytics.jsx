    ...
    <div className="scroll-area">
      ...
      <div className="stat-grid sg4">
        ...
        <div className="stat-card">
          ...
          <div className="stat-change up">▲ +21% MoM</div>
        </div>
      </div>
      ...
      <div className="g2">
        ...
        <div className="panel" style={{ marginBottom: 0 }}>
          <div className="panel-header"><div className="panel-title">📈 Transaksi Harian (7 Hari)</div></div>
        ...
        {/* Top Tenants */}
        <div className="panel" style={{ marginBottom: 0 }}>
          <div className="panel-header"><div className="panel-title">🏪 Top Tenant (GMV Bulan Ini)</div></div>
          <div className="panel-body">
      ...
      <div className="g3" style={{ marginTop: 12 }}>
        ...
        <div className="stat-card">
          ...
          <div className="stat-change up">▲ Fast</div>
        </div>
      </div>
    </div>
  );
